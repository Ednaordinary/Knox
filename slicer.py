...
class Slicer:
    ...
    def slice(self, paths, out):
        # yes this is gross
        # doing it anyways
        subprocess.run("./OrcaSlicer.AppImage --load-settings \"orca-input/standard.json;orca-input/a1.json\" --load-filaments \"orca-input/pla.json\" --orient 1 --arrange 1 --slice 0 --outputdir " + str(out) + " --slice 0 " + " ".join(paths), shell=True, cwd=os.getcwd())
