...
Written by Ryan Zambrotta (from gcody)
Modified by Edna
'''
...
def read(file=None, no_travel=False, **kwargs):
    '''
    Parameters:
    ...
    for line in f:
        ...
        if line[0] == 'G':
            ...
            for i in [x for x in commands[1:] if x.strip() != ""]:
                ...
                # ignoring unknown commands
                    ...
                    print('Unknown parameter, {}, passed to command {}'.format(i[2:],i[0:2]))
            ...
            try:
                ...
                # command is not implemented. do nothing
                pass
        ...
        # if the line is a comment line
            ...
            print('Unknown command {}, Skipping command'.format(line))
