'''
Class gcode written by Ryan Zambrotta (from gcody)
Modified by Edna
'''
...
class gcode():
    ...
    def animated(self, *args, fig_title='Print Path',**kwargs):
        ...
        # list comprehension to get the coordinates from self.history
        ...
        if "frames" in kwargs:
            ...
            del kwargs['frames']
        sparsity = len(self.t) // frames
        kwargs['sparsity'] = sparsity if sparsity > 0 else 1
